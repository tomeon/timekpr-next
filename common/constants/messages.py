...
def initMessages():
    ...
    _messages["TK_MSG_USER_ADMIN_CMD_USERLIST"] = {
        "s": _("==> get saved user list from the server, example")
    }
    _messages["TK_MSG_USER_ADMIN_CMD_USERCONFIG"] = {
        "s": _(
            "==> get user configuration and time information from the server, example"
        )
    }
    _messages["TK_MSG_USER_ADMIN_CMD_USERCONFIGRT"] = {
        "s": _("==> get realtime user time information from the server, example")
    }
    _messages["TK_MSG_USER_ADMIN_CMD_SETALLOWEDDAYS"] = {
        "s": _("==> set allowed days for the user, example")
    }
    # TRANSLATORS: please DO NOT translate the keyword "ALL"
    _messages["TK_MSG_USER_ADMIN_CMD_SETALLOWEDHOURS"] = {
        "s": _(
    ...
    _messages["TK_MSG_USER_ADMIN_CMD_SETTIMELIMITS"] = {
        "s": _(
            "==> set time limits for all allowed days, the number of values must not exceed the allowed days for the user, example"
        )
    }
    _messages["TK_MSG_USER_ADMIN_CMD_SETTIMELIMITWK"] = {
        "s": _("==> set time limit per week, example")
    }
    _messages["TK_MSG_USER_ADMIN_CMD_SETTIMELIMITMON"] = {
        "s": _("==> set time limit per month, example")
    }
    _messages["TK_MSG_USER_ADMIN_CMD_SETTRACKINACTIVE"] = {
        "s": _("==> set whether to track inactive user sessions, example")
    }
    ...
    _messages["TK_MSG_ADMIN_CHK_CTRLSESSIONS_NONE"] = {
        "s": _("Control sessions types are not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_CTRLSESSIONS_INVALID"] = {
        "s": _("Control sessions types list is not correct")
    }
    _messages["TK_MSG_ADMIN_CHK_CTRLSESSIONS_INVALID_SET"] = {
        "s": _("Control sessions types list is not correct and cannot be set")
    }
    _messages["TK_MSG_ADMIN_CHK_EXCLSESSIONW_NONE"] = {
        "s": _("Excluded session types are not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_EXCLSESSIONS_INVALID"] = {
        "s": _("Excluded session types list is not correct")
    }
    _messages["TK_MSG_ADMIN_CHK_EXCLSESSIONS_INVALID_SET"] = {
        "s": _("Excluded session types list is not correct and cannot be set")
    }
    _messages["TK_MSG_ADMIN_CHK_EXCLUSERS_NONE"] = {
        "s": _("Excluded user list is not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_EXCLUSERS_INVALID"] = {
        "s": _("Excluded user list is not correct")
    }
    _messages["TK_MSG_ADMIN_CHK_EXCLUSERS_INVALID_SET"] = {
        "s": _("Excluded user list is not correct and cannot be set")
    }
    _messages["TK_MSG_ADMIN_CHK_FINALWARNTIME_NONE"] = {
        "s": _("Final warning time is not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_FINALWARNTIME_INVALID"] = {
        "s": _('Final warning time "%%s" is not correct')
    }
    _messages["TK_MSG_ADMIN_CHK_FINALWARNTIME_INVALID_SET"] = {
        "s": _('Final warning time "%%s" is not correct and cannot be set')
    }
    _messages["TK_MSG_ADMIN_CHK_FINALNOTIFTIME_NONE"] = {
        "s": _("Final notification time is not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_FINALNOTIFTIME_INVALID"] = {
        "s": _('Final notification time "%%s" is not correct')
    }
    _messages["TK_MSG_ADMIN_CHK_FINALNOTIFTIME_INVALID_SET"] = {
        "s": _('Final notification time "%%s" is not correct and cannot be set')
    }
    _messages["TK_MSG_ADMIN_CHK_TERMTIME_NONE"] = {
        "s": _("Termination time is not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_TERMTIME_INVALID"] = {
        "s": _('Termination time "%%s" is not correct')
    }
    _messages["TK_MSG_ADMIN_CHK_TERMTIME_INVALID_SET"] = {
        "s": _('Termination time "%%s" is not correct and cannot be set')
    }
    _messages["TK_MSG_ADMIN_CHK_TRACKINACTIVE_NONE"] = {
        "s": _("Track inactive is not passed")
    }
    _messages["TK_MSG_ADMIN_CHK_TRACKINACTIVE_INVALID"] = {
        "s": _('Track inactive "%%s" is not correct')
    }
    _messages["TK_MSG_ADMIN_CHK_TRACKINACTIVE_INVALID_SET"] = {
        "s": _('Track inactive "%%s" is not correct and cannot be set')
    }
    _messages["TK_MSG_ADMIN_CHK_LOGLEVEL_NONE"] = {"s": _("Log level is not passed")}
    _messages["TK_MSG_ADMIN_CHK_LOGLEVEL_INVALID"] = {
        "s": _('Log level "%%s" is not correct')
    }
    _messages["TK_MSG_ADMIN_CHK_LOGLEVEL_INVALID_SET"] = {
        "s": _('Log level "%%s" is not correct and cannot be set')
    }
    _messages["TK_MSG_ADMIN_CHK_POLLTIME_NONE"] = {"s": _("Poll time is not passed")}
    _messages["TK_MSG_ADMIN_CHK_POLLTIME_INVALID"] = {
        "s": _('Poll time "%%s" is not correct')
    }
    _messages["TK_MSG_ADMIN_CHK_POLLTIME_INVALID_SET"] = {
        "s": _('Poll time "%%s" is not correct and cannot be set')
    }
    _messages["TK_MSG_ADMIN_CHK_SAVETIME_NONE"] = {"s": _("Save time is not passed")}
    _messages["TK_MSG_ADMIN_CHK_SAVETIME_INVALID"] = {
        "s": _('Save time "%%s" is not correct')
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CHK_ALLOWEDHOURS_DAY_NONE"] = {
        "s": _('User\'s "%%s" day number must be present')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_ALLOWEDHOURS_DAY_INVALID"] = {
        "s": _('User\'s "%%s" day number must be between 1 and 7')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_ALLOWEDHOURS_INVALID_SET"] = {
        "s": _('User\'s "%%s" allowed hours are not correct and cannot be set')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_DAYLIST_NONE"] = {
        "s": _('User\'s "%%s" day list is not passed')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_DAYLIST_INVALID"] = {
        "s": _('User\'s "%%s" day list is not correct')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_DAYLIST_INVALID_SET"] = {
        "s": _('User\'s "%%s" day list is not correct and cannot be set')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_DAILYLIMITS_NONE"] = {
        "s": _('User\'s "%%s" day limits list is not passed')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_DAILYLIMITS_INVALID"] = {
        "s": _('User\'s "%%s" day limits list is not correct')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_DAILYLIMITS_INVALID_SET"] = {
        "s": _('User\'s "%%s" day limits list is not correct and cannot be set')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_TIMELIMIT_OPERATION_INVALID"] = {
        "s": _('User\'s "%%s" time operation can be one of these: - + =')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_TIMELIMIT_INVALID"] = {
        "s": _('User\'s "%%s" time limit is not correct')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_TIMELIMIT_INVALID_SET"] = {
        "s": _('User\'s "%%s" time limit is not correct and cannot be set')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_MONTHLYALLOWANCE_NONE"] = {
        "s": _('User\'s "%%s" monthly allowance is not passed')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_MONTHLYALLOWANCE_INVALID"] = {
        "s": _('User\'s "%%s" monthly allowance is not correct')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_MONTHLYALLOWANCE_INVALID_SET"] = {
        "s": _('User\'s "%%s" monthly allowance is not correct and cannot be set')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_TRACKINACTIVE_NONE"] = {
        "s": _('User\'s "%%s" track inactive flag is not passed')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_TRACKINACTIVE_INVALID"] = {
        "s": _('User\'s "%%s" track inactive flag is not correct')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_TRACKINACTIVE_INVALID_SET"] = {
        "s": _('User\'s "%%s" track inactive flag is not correct and cannot be set')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_HIDETRAYICON_NONE"] = {
        "s": _('User\'s "%%s" hide tray icon flag is not passed')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_HIDETRAYICON_INVALID"] = {
        "s": _('User\'s "%%s" hide tray icon flag is not correct')
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CHK_WEEKLYALLOWANCE_INVALID"] = {
        "s": _('User\'s "%%s" weekly allowance is not correct')
    }
    ...
    # TRANSLATORS: this message must be 80 symbols long at max
    _messages["TK_MSG_STATUS_CONNECTION_ACCESS_DENIED"] = {
        "s": _(
    ...
    _messages["TK_MSG_STATUS_USER_CONFIG_RETRIEVED"] = {
        "s": _("User configuration retrieved")
    }
    _messages["TK_MSG_STATUS_CONFIG_RETRIEVED"] = {"s": _("Configuration retrieved")}
    _messages["TK_MSG_STATUS_TRACKINACTIVE_PROCESSED"] = {
        "s": _("Track inactive for user has been processed")
    }
    ...
    _messages["TK_MSG_STATUS_ALLOWEDDAYS_PROCESSED"] = {
        "s": _("Allowed days for user have been processed")
    }
    _messages["TK_MSG_STATUS_TIMELIMITS_PROCESSED"] = {
        "s": _("Day time limits for user have been processed")
    }
    _messages["TK_MSG_STATUS_ALLOWEDHOURS_PROCESSED"] = {
        "s": _("Allowed hours for user have been processed")
    }
    _messages["TK_MSG_STATUS_CONFIGURATION_SAVED"] = {
        "s": _("Timekpr-nExT configuration has been saved")
    }
    ...
    _messages["TK_MSG_STATUS_INTERVAL_OVERLAP_DETECTED"] = {
        "s": _("That interval overlaps with an existing one")
    }
    _messages["TK_MSG_STATUS_INTERVALSTART_CONFLICT_DETECTED"] = {
        "s": _("That interval's start conflicts with an existing one")
    }
    _messages["TK_MSG_STATUS_INTERVALEND_CONFLICT_DETECTED"] = {
        "s": _("That interval's end conflicts with an existing one")
    }
    _messages["TK_MSG_STATUS_INTERVAL_DUPLICATE_DETECTED"] = {
        "s": _("That interval's start or end duplicates an existing one")
    }
    _messages["TK_MSG_STATUS_INTERVAL_STARTENDEQUAL_DETECTED"] = {
        "s": _("Interval start cannot be the same as end")
    }
    _messages["TK_MSG_STATUS_INTERVAL_ENDLESSTHANSTART_DETECTED"] = {
        "s": _("Interval's start cannot be later than end")
    }
    _messages["TK_MSG_STATUS_NOHOUR_SELECTED"] = {
        "s": _("Please select an hour interval to remove")
    }
    _messages["TK_MSG_STATUS_INTERVAL_REMOVED"] = {"s": _("Interval removed")}
    _messages["TK_MSG_STATUS_INTERFACE_NOTREADY"] = {
        "s": _("Timekpr-nExT interface is not yet ready")
    }

    # ## this defines messages for use in CLI ##
    _messages["TK_MSG_CONSOLE_GUI_NOT_AVAILABLE"] = {
        "s": _(
    ...
    _messages["TK_MSG_CONSOLE_COMMAND_INCORRECT"] = {
        "s": _("The command is incorrect:")
    }
    _messages["TK_MSG_CONSOLE_USAGE_NOTES"] = {
        "s": _("The usage of Timekpr-nExT admin client is as follows:")
    }
    _messages["TK_MSG_CONSOLE_USAGE_NOTICE_HEAD"] = {"s": _("---=== NOTICE ===---")}
    _messages["TK_MSG_CONSOLE_USAGE_NOTICE_TIME"] = {
        "s": _("numeric time values are in seconds")
    }
    _messages["TK_MSG_CONSOLE_USAGE_NOTICE_DAYS"] = {
        "s": _(
            "weekdays are numbered according to ISO 8601 (i.e. Monday is the first day, format: 1-7)"
        )
    }
    _messages["TK_MSG_CONSOLE_USAGE_NOTICE_HOURS"] = {
        "s": _(
            "hours are numbered according to ISO 8601 (i.e. 24h clock, format: 0-23)"
        )
    }

    _messages["TK_MSG_CONSOLE_USERS_TOTAL"] = {
        "s": __("%(n)s user in total:", "%(n)s users in total:")[0],
        "p": __("%(n)s user in total:", "%(n)s users in total:")[1],
    }
    ...
    _messages["TK_MSG_NOTIFICATION_ALLOWANCE_CHANGED"] = {
        "s": _("Time allowance has changed, please note new time left!")
    }
    _messages["TK_MSG_NOTIFICATION_CONFIGURATION_CHANGED"] = {
        "s": _("Time limit configuration has changed, please note new configuration!")
    }
    _messages["TK_MSG_NOTIFICATION_CANNOT_CONNECT"] = {
        "s": _("There is a problem connecting to Timekpr-nExT daemon (%%s)!")
    }
    _messages["TK_MSG_NOTIFICATION_CANNOT_COMMUNICATE"] = {
        "s": _("There is a problem communicating to Timekpr-nExT (%%s)!")
    }
    _messages["TK_MSG_NOTIFICATION_CANNOT_INIT_ICON"] = {
        "s": _("Icon initialization error (%%s)!")
    }
    ...
    _messages["TK_MSG_NOTIFICATION_TIME_IS_UP_2"] = {
        ...
        "p": __("%(n)s second", "%(n)s seconds")[1],
    }
    _messages["TK_MSG_NOTIFICATION_CONNECTION_ERROR"] = {
        "s": _("Internal connection error, please check log files")
    }
    # TRANSLATORS: this is a part of message "You have %i hour(s), %i minute(s) and %i second(s) left" please translate accordingly
    _messages["TK_MSG_NOTIFICATION_TIME_LEFT_1"] = {
        "s": __("You have %(n)s hour", "You have %(n)s hours")[0],
        "p": __("You have %(n)s hour", "You have %(n)s hours")[1],
    }
    # TRANSLATORS: this is a part of message "You have %i hour(s), %i minute(s) and %i second(s) left" please translate accordingly
    _messages["TK_MSG_NOTIFICATION_TIME_LEFT_2"] = {
        "s": __("%(n)s minute", "%(n)s minutes")[0],
        "p": __("%(n)s minute", "%(n)s minutes")[1],
    }
    # TRANSLATORS: this is a part of message "You have %i hour(s), %i minute(s) and %i second(s) left" please translate accordingly
    ...
    _messages["TK_MSG_PARSE_ERROR"] = {
        "s": _("PARAMETER PARSE ERROR (please check parameter validity): %%s")
    }
    _messages["TK_MSG_DBUS_COMMUNICATION_COMMAND_FAILED"] = {
        "s": _("Command FAILED: access denied")
    }
    _messages["TK_MSG_DBUS_NOT_AUTHORIZED"] = {
        "s": _('Not authorized for action "%%s"')
    }
    _messages["TK_MSG_DBUS_NOT_OWN_USER"] = {
        "s": _('Only user "%%s" or the superuser may call this method')
    }
    _messages["TK_MSG_DBUS_COMMUNICATION_COMMAND_NOT_ACCEPTED"] = {
        "s": _("Command FAILED: communication was not accepted")
    }
    _messages["TK_MSG_TRANSLATION_NOTFOUND"] = {"s": _("n/a")}
    _messages["TK_MSG_TRANSLATOR_CREDITS"] = {
        "s": "please-enter-translator-credits"
    }  # special case
...
def getTranslation(pMsgCode, n=None):
    ...
    if pMsgCode not in _messages:
        ...
        if "p" in _messages[pMsgCode] and n is not None:
            # numbers
            try:
                result = _translatePlural(
                    _messages[pMsgCode]["s"], _messages[pMsgCode]["p"], n
                ) % {"n": n}
            except Exception:
                pass
